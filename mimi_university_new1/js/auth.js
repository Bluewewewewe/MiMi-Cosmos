// ==================== 密码显示/隐藏功能 ====================
// 闭眼图标 SVG - 隐藏状态
const eyeCloseSvg = '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M1 12s4-8 11-8 11 8 11 8" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M2 2l20 20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>';
// 睁眼图标 SVG - 显示状态
const eyeOpenSvg = '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="3.5" fill="currentColor" opacity="0.6"/><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>';

function togglePasswordVisibility(inputId) {
    const input = document.getElementById(inputId);
    const button = input.parentElement.querySelector('.pwd-toggle');
